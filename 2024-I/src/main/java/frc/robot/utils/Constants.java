...
public final class Constants {
  ...
  public static class ScoringConstants {
    ...
    public static final double kLeftFlywheelAmpRPM = 2000; //if ok, maybe revert if spin is not useful
    public static final double kRightFlywheelAmpRPM = 3000; //was 750
