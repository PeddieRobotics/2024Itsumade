...
public class Arm extends SubsystemBase {
  ...
  public Arm() {
    ...
    armPrimaryMotor.setSmartCurrentLimit(ArmConstants.ARM_PRIMARY_MOTOR_LIMIT);
    armSecondaryMotor.setSmartCurrentLimit(ArmConstants.ARM_SECONDARY_MOTOR_LIMIT);
    ...
    armPIDController.setIZone(ArmConstants.ARM_IZONE);
  }
